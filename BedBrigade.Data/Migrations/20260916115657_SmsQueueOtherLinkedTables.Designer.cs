...
namespace BedBrigade.Data.Migrations
{
    ...
    [Migration("20260916115657_SmsQueueOtherLinkedTables")]
    partial class SmsQueueOtherLinkedTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BedBrigade.Common.Models.ContentHistory", b =>
                {
                    b.Property<int>("ContentHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ContentHistoryId"));
            ...
            modelBuilder.Entity("BedBrigade.Common.Models.DonationCampaign", b =>
                {
                    b.Property<int>("DonationCampaignId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BedBrigade.Common.Models.Location", b =>
                {
                    ...
                    b.Property<string>("ExternalContactUs")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<bool>("ExternalContent")
                        .HasColumnType("bit");

                    b.Property<string>("ExternalDonate")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("ExternalHome")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("ExternalRequestABed")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("ExternalVolunteer")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
            ...
            modelBuilder.Entity("BedBrigade.Common.Models.Volunteer", b =>
                {
                    ...
                    b.Property<int?>("CanYouTranslate")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("VolunteerArea")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("BedBrigade.Common.Models.EmailQueue", b =>
                {
                    ...
                    b.HasOne("BedBrigade.Common.Models.SignUp", "ContactUs")
                        .WithMany()
            ...
            modelBuilder.Entity("BedBrigade.Common.Models.SmsQueue", b =>
                {
                    ...
                    b.HasOne("BedBrigade.Common.Models.ContactUs", "ContactUs")
                        .WithMany()
                        .HasForeignKey("ContactUsId");

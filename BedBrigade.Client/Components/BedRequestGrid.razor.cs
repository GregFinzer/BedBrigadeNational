    ...
    public partial class BedRequestGrid : ComponentBase
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            try
            {
                ...
                // Fix for CS8602: Check for null before dereferencing _svcAuth
                if (_svcAuth != null)
                {
        ...
        private async Task LoadBedRequests()
        {
            ...
            if (userLocationResult.Success && userLocationResult.Data != null)
            {
                ...
                {
                    // Fix for CS8602: Check for null before dereferencing _svcMetroArea
                    ...
                    // Fix for CS8629: Ensure MetroAreaId has a value before using .Value
                    if (!userLocationResult.Data.MetroAreaId.HasValue)
                    {
                        Log.Error("MetroAreaId is null for metro location.");
                        return;
                    }
        ...
        private void NavigateToAdd()
        {
            ...
            _nav.NavigateTo($"/administration/admintasks/addeditbedrequest/{loc}");
        }
        ...
        private async Task NavigateToEdit(ActionEventArgs<BedRequest> args)
        {
            ...
            _nav.NavigateTo($"/administration/admintasks/addeditbedrequest/{loc}/{id}");
        }

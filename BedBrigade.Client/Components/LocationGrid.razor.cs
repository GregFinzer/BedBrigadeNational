...
namespace BedBrigade.Client.Components
{
    public partial class LocationGrid : ComponentBase
    {
        ...
        protected async Task OnLoad()
        {
            ...
            await GridPersistenceHelper.LoadGridPersistenceAsync(Grid, _svcUserPersist, userName, PersistGrid.Location);
        }
        ...
        protected async Task PdfExport()
        {
            if (Grid != null)
            {
                ...
                {
                    FileName = FileUtil.BuildFileNameWithDate("Locations", ".pdf"),
        ...
        protected async Task ExcelExport()
        {
            if (Grid != null)
            {
                ...
                {
                    FileName = FileUtil.BuildFileNameWithDate("Locations", ".xlsx"),
                };
        ...
        protected async Task CsvExportAsync()
        {
            if (Grid != null)
            {
                ExcelExportProperties exportProperties = new ExcelExportProperties
                {
                    FileName = FileUtil.BuildFileNameWithDate("Locations", ".csv"),
                };
